...
class SS2Dv2:
    ...
    def forward_corev2(
        ...
        **kwargs,
        ...
        B, D, H, W = x.shape    # such as 128 768 14 14
        D, N = A_logs.shape      # such as 768 1
        K, D, R = dt_projs_weight.shape      # such as 4 768 24
        L = H * W   # such as 196
        ...
        if cascade2d:
            ...
            xs = CrossScan.apply(x) # 128, 4, 768, 196
            if no_einsum:
                ...
                dts, Bs, Cs = torch.split(x_dbl.view(B, K, -1, L), [R, N, N], dim=2)    # [128, 4, 24, 196], [128, 4, 1, 196], [128, 4, 1, 196]
                dts = F.conv1d(dts.contiguous().view(B, -1, L), dt_projs_weight.view(K * D, -1, 1), groups=K)   # [128, 3072, 196]
            else:
